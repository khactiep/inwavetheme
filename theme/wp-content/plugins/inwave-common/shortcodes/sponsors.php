...
if (!class_exists('Inwave_Sponsors_Slider')) {
    ...
    class Inwave_Sponsors_Slider extends Inwave_Shortcode2{
        ...
        function init_params2(){
            ...
            return array(
                ...
                "params" => array(
                    ...
                    array(
                        'type' => 'attach_image',
                        "heading" => __("Image 2", "inwavethemes"),
                        "param_name" => "img2",
                        "description" => "",
        ...
        function init_shortcode($atts, $content = null) {
            ...
            $output = '<div class="iw-sponsors-list clearfix ' . $class . '">';
        ...
        function init_shortcode2($atts, $content = null) {
            ...
            if ($img2) {
                ...
                $img2 = $img2[0];
                $size = '';
                $img_2 .= '<img ' . $size . ' src="' . $img2 . '" alt="">';
            }
            switch ($style) {
                case 'style1':
                    $output .= '<div class="iw-sponsors-item col-md-3 col-sm-3 col-xs-12">';
                        $output .= '<div class="iw-info-item ' . $class . '">';
                        if ($img_tag) {
                            $output .= '<div class="img-1">' .$img_tag. '</div>';
                        }
                        if ($img_2) {
                            $output .= '<div class="img-2">' .$img_2. '</div>';
                        }
                        $output .= '</div>';
                    $output .= '</div>';
                break;
