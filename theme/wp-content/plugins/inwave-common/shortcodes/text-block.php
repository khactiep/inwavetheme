...
if (!class_exists('Inwave_Text_Block')) {
    ...
    class Inwave_Text_Block extends Inwave_Shortcode{
        ...
        function init_params() {
            ...
            return array(
                ...
                'params' => array(
                    ...
                    array(
                        "type" => "dropdown",
                        "heading" => __("Font Family", "inwavethemes"),
                        "param_name" => "font_family",
                        "description" => __('Font family of this text block. Default body font family', "inwavethemes"),
                        "value" => $google_fonts,
                    ),
                    array(
                        "type" => "dropdown",
                        "heading" => __("Load Font Family from google", "inwavethemes"),
                        "param_name" => "load_font",
                        "value" => array(
                            __('No', "inwavethemes") => '',
                    ...
                    array(
                        ...
                        "description" => __('Font weight of this text block. Default body font weight', "inwavethemes"),
                        "value" => $font_weight,
                    ),
                    array(
                        "type" => "textfield",
        ...
        function init_shortcode($atts, $content = null) {
            ...
            if($font_family){
                if($load_font && !isset(Inwave_Shortcode::$loadfonts[$font_family.$font_weight])){
                    $font_url = "http" . ((is_ssl()) ? 's' : '') . "://fonts.googleapis.com/css?family={$font_family}";
                    wp_enqueue_style('google-font-'.strtolower(str_replace(" ", "-", $font_family.$font_weight)), $font_url);
                    Inwave_Shortcode::$loadfonts[$font_family.$font_weight] = true;
                }
            ...
            $output .= '<div class="inwave-text-block text-'.esc_attr($align).' '.trim($class).'">';
