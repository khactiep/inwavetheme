...
if(!function_exists('inwave_plugins_load')){
    ...
    function inwave_plugins_load() {
        ...
        $plugins = array(
            ...
            array(
                'name'               => esc_html__('injob Events', 'injob'),
                'slug'               => 'injob',
                'source'             => get_template_directory() . '/framework/plugins/injob.zip',
                'required'           => true,
                'version'            => '1.0',
                'force_activation'   => false,
                'force_deactivation' => false,
            ...
            array(
                'name'               => esc_html__('InWave Common for Medical', 'injob'),
                'slug'               => 'inwave-common',
            ...
            array(
                'name'      => esc_html__('Woocommerce', 'injob'),
                'slug'      => 'woocommerce',
                'required'  => false,
            ),
            /*array(
                'name'      => esc_html__('YITH Woocommerce Wishlist', 'injob'),
