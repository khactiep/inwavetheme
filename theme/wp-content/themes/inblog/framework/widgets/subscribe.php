...
class Inwave_Widget_Subscribe extends WP_Widget {
    ...
    function widget( $args, $instance ) {
		...
		echo '<div class="text_sub">'.esc_html__('Follow my lasted news', 'injob').'</div>';
        ...
        $output .= '<input class="mc-email" type="email" placeholder="' .esc_attr(esc_html__('Your email', 'injob')) .'">';
