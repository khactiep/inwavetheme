(function ($) {
    ...
    ** Add Class to sub-menu
    ...
    $(document).ready(function () {
        ...
        if($('.iwj-find-jobs-select').length) {
            $(".iwj-find-jobs-select").select2({
...
//        var highestBox = 0;
//        var item = $('.iw-recent-jobs .row > div .recent-job-item');
//        item.each(function(){
...
//        item.height(highestBox);
        ...
        $(window).on('load resize',function () {
            equalheight('.iw-recent-jobs .row .iwj-item, .iwj-featured-jobs .row .iwj-item, .iwj-jobs-grid .iwj-job-item,' +
                ' .iwj-jobs-grid .iwj-employer-item, .iw-recent-resumes .iwj-item, .iw-job-detail .job-detail-info ul li');
        }());
...
//
//    $(window).on('load resize',function () {
//        equalheight('.iw-recent-jobs .row > div');
//    }());
//})(jQuery);
